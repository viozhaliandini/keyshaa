...
function init() {
  ...
  function drawText() {
    ...
    ctx.fillText("wofyuu keyca imuppp", width / 2, height / 2.2 + 400);
  }
  ...
  function drawText() {
    ...
    ctx.font = "20px Arial"; // Ukuran font lebih kecil
    ctx.fillStyle = "lightblue"; // Warna teks
    ctx.fillText("klik buat lanjutin lagunya", width / 2, height / 2.2 + 460); // Posisi teks
}
